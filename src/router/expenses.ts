...
import { createNewExpense, getAllPeriodExpenses, deleteExpense, updateExpense, getExpense, getAllExpensesByCategory } from "../controllers/expenses"
...
export default (router: express.Router) => {
    ...
    router.get('/expenses/category/:category', isAuthenticated, getAllExpensesByCategory);
